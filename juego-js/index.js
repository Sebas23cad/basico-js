...
// clase numero 45 don't repeat yourself
...
function crearMensaje(resultado) {
    ...
    let ataques_del_jugador = document.getElementById('ataquesDelJugador')
    let ataques_del_enemigo = document.getElementById('ataquesDelEnemigo')
